...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // update
        $wallet_kantin = Transaction::whereIn("status", ["dibayar", "diambil"])->get();
        $saldoKantin = $wallet_kantin->sum('price');
        ...
        if ($user->roles_id == 2) return view("kantin", compact("user", "wallet", "saldoKantin", "products", "transactionsKeranjang", "transactionsBayar", "categories", "product_deleted"));
